...
const DeveloperDashboard: React.FC = () => {
  ...
  const tasks: TaskItem[] = [
   { name: "Design Product Card Component", date: "08-08-2025", status: "In Progress" },
  { name: "Implement Shopping Cart UI", date: "10-08-2025", status: "To Do" },
  { name: "Create User Login Form", date: "12-08-2025", status: "Review" },
  { name: "Build Product Filter Sidebar", date: "15-08-2025", status: "To Do" },
  { name: "Responsive Header Navigation", date: "18-08-2025", status: "Completed" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mb-16 mt-6">
              ...
              <h1 className="text-4xl font-bold text-[#FB5711]">Kavya Nair</h1>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-8 gap-6 mb-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 lg:col-span-5">
                ...
                <div className="space-y-0">
                  {tasks.map((task, index) => (
                    <div key={index} className="grid grid-cols-3 gap-4 py-3 border-b border-gray-200 last:border-b-0">
                      <span className="text-gray-800 font-base">{task.name}</span>
                      <span className="text-gray-600 text-sm text-center">{task.date}</span>
                      <span className="text-gray-600 text-end">{task.status}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 lg:col-span-3">
                <h2 className="text-xl font-base mb-6 text-black">Projects List</h2>
                <div className="space-y-4">
                  {projects.map((project, index) => (
                    <div key={index} className="bg-orange-50 p-4 rounded-lg" onClick={handleProjectClick}>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-gray-800 font-base">{project.name}</span>
                        <div className="text-right">
                          <div className="text-xs text-gray-500">Deadline</div>
                          <div className="text-sm text-gray-700">{project.date}</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm text-gray-600">Progress</span>
                        <span className="text-sm text-gray-700">{project.percentage}</span>
                      </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h2 className="text-xl font-base mb-6 text-black">Progress Graph</h2>
              ...
              <div className="space-y-4 h-full flex flex-col">
                ...
                <div className="bg-white rounded-xl p-6 text-center relative">
                  ...
                  <div className="w-20 h-20 bg-gray-300 rounded-full mx-auto mb-4 overflow-hidden">
                    <Image src={sampleProfile} alt='profile' className="w-full h-full object-cover object-top"/>
                  </div>
                  <h3 className="text-xl font-base mb-6 text-black">Kavya Nair</h3>
                  <p className="text-sm text-gray-600">Passionate frontend developer specializing in React and modern web technologies. Focused on creating intuitive user experiences for e-commerce platforms.</p>
                </div>

                {/* Today's Event */}
                <div className="bg-white rounded-xl p-6 flex-1">
                  <h3 className="text-xl font-base mb-6 text-black">Today's Event</h3>
                  <div className="space-y-3">
                    {events.map((event, index) => (
                      <div key={index} className="bg-orange-100 rounded-lg p-3 flex items-start space-x-3">
                        <Video className='w-5 h-5 text-black' />
                        <div>
                          <p className="text-sm font-base text-gray-800">{event.time}</p>
                ...
                <div className="bg-white rounded-xl p-6 flex-1">
                  <div className="flex items-center space-x-2 mb-6">
                    <h3 className="text-xl font-base text-black">Notification</h3>
                  </div>
